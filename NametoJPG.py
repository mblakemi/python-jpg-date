# NametoJPG
# For jpg photos in sInDir
# Add 'date' from jpg name to photo image and resave in sOutDir
...
#18-10-24 Minor editing
#19-04-12 Added Rotate option based on EXIF info
#19-067-01 Added bCompressOnly option to NOT add date
...
# Recursive in directory (do not use trailing '\\')
# sFolder used to convert subfolder 

sFolder = '2018 temp' # 'Subfolder of sOutDir to be used
sIndir = 'e:\\Archive\\Best Photo\\Best Photo 5\\' + sFolder
sIndir = 'in_name'

sOutDir = 'out\\' + sFolder   #use this if sFolder defined as subfolder
sOutDir = 'out'
...
# determine if photo rotated 1 = not rotated
...
# For file 'in_dir_name/in_name' 
# add text from name to image and resave in out_dir_name
...
def process_dir(sIndir, sOutdir, sFile):
  ...
  # if sFileDir is a file, convert it and return
  ...
  # create directory it if necessary
  try: 
